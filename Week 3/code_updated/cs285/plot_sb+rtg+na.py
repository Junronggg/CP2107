...
experiment_groups = {
    ...
    'Small batch with normalized advantage': [
        'D:\work\CP2107\homework_fall2023\hw2\data\q2_pg_cartpole_na_CartPole-v0_17-06-2025_11-23-49',
        'D:\work\CP2107\homework_fall2023\hw2\data\q2_pg_cartpole_na_seed10_CartPole-v0_17-06-2025_11-26-45'
    ],
    'Small batch with RTG + NA': [
        'D:\work\CP2107\homework_fall2023\hw2\data\q2_pg_cartpole_na_rtg_CartPole-v0_17-06-2025_11-25-02',
        'D:\work\CP2107\homework_fall2023\hw2\data\q2_pg_cartpole_rtg_na_seed10_CartPole-v0_17-06-2025_11-29-57'
    ]
}

colors = {
    'Small batch without RTG + NA': "#8EEFE0",  # light green-blue
    'Small batch with reward-to-go': "#61BF58",     # light green
    'Small batch with normalized advantage': "#FBF724", 
    'Small batch with RTG + NA': "#F4910F"
}   
# make surve smoother
...
plt.title('Effect of Reward-to-go (rtg) & normalized advantage (NA) on Small Batch Data')
plt.xlabel('Training Iteration')
plt.ylabel('Average Return')
plt.legend()
plt.grid(True)
plt.tight_layout()
plt.savefig("cartpole_comparison_sb_rtg_na.png")
plt.show()
